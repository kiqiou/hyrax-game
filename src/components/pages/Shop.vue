<template>
  <div class="relative w-full min-h-screen overflow-auto bg-black">
    ...
    <RouterLink to="/" class="absolute top-5 left-5 text-white bg-black/50 backdrop-blur-sm rounded-full px-4 py-2 font-bold shadow-lg hover:bg-black/70 transition-colors duration-300">
      <- Back
    </RouterLink>
    <div
      ...
      >
        ...
        <div v-else
          class="
            ...
            text-white
            shadow-lg
          "><p class="text-center">Purchased</p></div>
